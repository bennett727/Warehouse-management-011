  ...
  <el-form ref="formRef" :model="modelValue" :rules="formRules" label-width="120px" class="detail-form">
    <div class="form-section">
      ...
      <el-row :gutter="24">
        ...
        <el-col :span="12">
          <el-form-item label="入库来源" prop="inboundSource">
            <el-select v-model="modelValue.inboundSource" placeholder="请选择入库来源" style="width: 100%">
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="入库优先级" prop="priority">
        ...
        <el-col :span="12">
          <el-form-item label="关联单号" prop="relatedOrderNo">
            <el-input v-model="modelValue.relatedOrderNo" placeholder="请输入关联单号（如有）">
              <template #prefix>
      ...
      <el-row :gutter="24">
        <el-col :span="12">
          <el-form-item label="来源方" prop="sourceName">
            <el-input v-model="modelValue.sourceName" placeholder="请输入来源方名称" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="24">
        ...
        <el-col :span="12">
          <el-form-item label="来源地址" prop="sourceAddress">
            <el-input v-model="modelValue.sourceAddress" placeholder="请输入来源地址" />
          </el-form-item>
        </el-col>
      </el-row>
    </div>
      ...
      <el-row :gutter="24" v-if="modelValue.hasValue">
        <el-col :span="12">
          <el-form-item label="价值类型" prop="valueType">
            <el-select v-model="modelValue.valueType" placeholder="请选择价值类型" style="width: 100%">
        ...
        <el-col :span="12">
          <el-form-item label="评估人" prop="appraiser">
            <el-input v-model="modelValue.appraiser" placeholder="请输入评估人" />
          </el-form-item>
        </el-col>
      </el-row>
    </div>
