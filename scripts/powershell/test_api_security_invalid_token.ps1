# API Security Test Script - Invalid Token
# Test access to protected API endpoints with invalid token

$baseUrl = "http://localhost:8080"
$invalidToken = "Bearer eyJhbGciOiJIUzI1NiJ9.invalid.token.here"
$results = @()
...
Write-Host "API Security Test - Invalid Token" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($failCount -gt 0) {
    ...
    Write-Host "Security Vulnerabilities Found! Invalid Token Not Rejected:" -ForegroundColor Red
    Write-Host "========================================" -ForegroundColor Red
    Write-Host ""
...
$reportFile = "api_security_test_invalid_token_$timestamp.txt"
